...
const game1 = createMatch("Jugador A", "Jugador B");
const game2 = createMatch("Jugador C", "Jugador D");

const finalista1 = null, finalista2 = null;

console.log(game1.finPartido)

while (game1.finPartido === false){

  let randomPoint = Math.floor(Math.random() * 2) + 1;
  console.log (randomPoint);

  game1.finPartido = true;
}
